...
> **Note**: This is the **landing page repository**, not the main application repository.
> The actual Jeda app code is hosted in a separate private repository.
> This site is for marketing and documentation
